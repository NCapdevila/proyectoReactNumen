  ...
  return (
    ...
    <div>
      ...
      <div className={`navBar__Container ${fixed ? 'navbar_fixed' : 'navbar_notfixed'}`}>
        ...
        <svg width="25" height="24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M10.934 18.75a7.875 7.875 0 100-15.75 7.875 7.875 0 000 15.75zM16.502 16.443L21.058 21" stroke="#989BA0" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path></svg>
